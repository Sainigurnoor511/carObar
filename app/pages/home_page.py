from tkinter import Tk, ttk, Frame, Button, Label, Menu
from PIL import Image, ImageTk
from app.pages import buy_car_page
...
from app.pages import update_password_page
...
class HomePage:
    ...
    def homepage_widgets(self):
        ...
        self.image_path = Image.open('app/assets/background.jpg').resize((1000,564))
        ...
        self.image_path = Image.open('app/assets/home_page/sidebar.png').resize((45,45))
        ...
        self.image_path = Image.open('app/assets/home_page/user.png').resize((45,45))
    ...
    def open_sidebar(self):
        ...
        self.image_path = Image.open('app/assets/home_page/back.png').resize((20,20))
        ...
        self.image_path = Image.open('app/assets/home_page/dashboard.png').resize((150,30))
        ...
        self.image_path = Image.open('app/assets/home_page/buycar.png').resize((150,30))
        ...
        self.image_path = Image.open('app/assets/home_page/sellcar.png').resize((150,30))
        ...
        self.image_path = Image.open('app/assets/home_page/services.png').resize((150,30))
        ...
        self.image_path = Image.open('app/assets/home_page\exit.png').resize((80,35))
    ...
    def open_dashboard(self):
        ...
        self.image_path = Image.open('app/assets/home_page/sidebar.png').resize((40,40))
        self.sidebar_image = ImageTk.PhotoImage(self.image_path)
        self.sidebar_button = Button(self.mainframe, image= self.sidebar_image, border=0, background="white", command= self.open_sidebar)
        self.sidebar_button.place(x=10,y=35)

        self.image_path = Image.open('app/assets/home_page/dashboard_buttons.png')
        ...
        self.image_path = Image.open('app/assets/home_page/graph.png').resize((478,400))
        ...
        # self.image_path = Image.open('assets/home_page/manage_database.png').resize((300, 50))
        ...
        # self.image_path = Image.open('assets/home_page/add_brandnew_cars.png').resize((305, 45))
        ...
        # self.image_path = Image.open('assets/home_page/generate_invoice.png').resize((301, 52))
    ...
    def open_manage_database(self):
        self.root.destroy()
        db = manage_catalogue_page.DisplayCars()
        db.button_frame()
    ...
    def open_invoice_generator(self):
        ig = invoice_generator_page.InvoiceGenerator()
        ig.widgets()
