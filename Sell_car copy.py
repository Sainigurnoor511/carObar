...
class Sellcar:
    ...
    ###---------------------------------/////// SELL CAR DETAILS //////------------------------------###
      ...
      #####---------------------------///// SELLER DETAILS  //////--------------------------------------------#####
        ...
        self.title2_label.place(x=340,y=400)
        ...
        self.user_image_path = Image.open('assets/frame0/button_6.png')
        self.user_imageTk2 = ImageTk.PhotoImage(self.user_image_path)
        self.sign_up = Button(self.sellcar_frame, image= self.user_imageTk2,borderwidth=0, command=self.get_sell_car_data)
        self.sign_up.place(x=330,y=640)
