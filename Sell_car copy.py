...
class Sellcar:
    ...
    ###---------------------------------/////// SELL CAR DETAILS //////------------------------------##
        ...
        self.title_label = ttk.Label(self.sellcar_frame, text="------ Enter Car Details ------",font=('Microsoft YaHei UI Light',14,'bold'))
        self.title_label.place(x=390,y=15)

        
        self.car_brand = ttk.Label(self.sellcar_frame,text="Enter the Car Brand",font = 20)
