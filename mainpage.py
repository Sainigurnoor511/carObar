...
class HomePage:
    ...
    def homepage_widgets(self):
        ...
        self.image_path = Image.open('assets/background.jpg').resize((1000,564))
        ...
        self.image_path = Image.open('assets/mainpage/sidebar.png').resize((45,45))
        ...
        self.image_path = Image.open('assets/mainpage/user.png').resize((45,45))
    ...
    def open_sidebar(self):
        ...
        self.image_path = Image.open('assets/mainpage/back.png').resize((20,20))
        ...
        self.image_path = Image.open('assets/mainpage/dashboard.png').resize((150,30))
        ...
        self.image_path = Image.open('assets/mainpage/buycar.png').resize((150,30))
        ...
        self.image_path = Image.open('assets/mainpage/sellcar.png').resize((150,30))
        ...
        self.image_path = Image.open('assets/mainpage/services.png').resize((150,30))
        ...
        self.image_path = Image.open('assets/mainpage\exit.png').resize((80,35))
    ...
    def open_dashboard(self):
        ...
        self.image_path = Image.open('assets/mainpage/sidebar.png').resize((40,40))
        self.sidebar_image = ImageTk.PhotoImage(self.image_path)
        self.sidebar_button = Button(self.mainframe, image= self.sidebar_image, border=0, background="white", command= self.open_sidebar)
        self.sidebar_button.place(x=10,y=35)

        self.image_path = Image.open('assets/mainpage/dashboard_buttons.png')
        ...
        self.image_path = Image.open('assets/mainpage/graph.png').resize((478,400))
        ...
        # self.image_path = Image.open('assets/mainpage/manage_database.png').resize((300, 50))
        ...
        # self.image_path = Image.open('assets/mainpage/add_brandnew_cars.png').resize((305, 45))
        ...
        # self.image_path = Image.open('assets/mainpage/generate_invoice.png').resize((301, 52))
