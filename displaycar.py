...
class DisplayCars:
    def __init__(self):
        ...
        self.manage_new_car_database = ttk.Button(self.root, width=40, text='Manage New Cars Database', command=self.display_new_cars)
        self.manage_new_car_database.place(x=130, y=50)

        self.manage_used_car_database = ttk.Button(self.root, width=40, text='Manage Used Cars Database', command=self.display_used_cars)
    ...
    def display_new_cars(self):
        ...
        self.tree_view = ttk.Treeview(self.new_car_frame,columns=("A","B","C","D","E","F","G"))
        ...
        self.tree_view.column("#5", anchor=CENTER,width=100)

        self.tree_view.heading("#6",text="DELETE")
        self.tree_view.column("#6", anchor=CENTER,width=100)

        self.tree_view.heading("#7",text="UPDATE")
        self.tree_view.column("#7", anchor=CENTER,width=100)

        

        for i in database.manage_new_cars():
            self.tree_view.insert("",0,text=i[0],values=(i[1], i[2], i[3], i[4], i[5], "Delete", "Update"))
        self.tree_view.bind("<Double-Button-1>", self.perform_actions1)    
    ...
    def display_used_cars(self):
        ...
        self.tree_view = ttk.Treeview(self.used_car_frame,columns=("A","B","C","D","E","F","G","H","I"))
        ...
        self.tree_view.heading("#4",text="KMS DRIVEN")
        self.tree_view.column("#4", anchor=CENTER,width=150)

        self.tree_view.heading("#5",text="REGISTRATION YEAR")
        self.tree_view.column("#5", anchor=CENTER,width=150)

        self.tree_view.heading("#6",text="OWNERSHIP")
        self.tree_view.column("#6", anchor=CENTER,width=100)

        self.tree_view.heading("#7",text="PRICE")
        self.tree_view.column("#7", anchor=CENTER,width=100)

        self.tree_view.heading("#8",text="DELETE")
        self.tree_view.column("#8", anchor=CENTER,width=100)

        self.tree_view.heading("#9",text="UPDATE")
        self.tree_view.column("#9", anchor=CENTER,width=100)
        

        for i in database.manage_used_cars():
            self.tree_view.insert("",0,text = i[0], values=(i[1], i[2], i[3], i[4], i[5], i[6], i[7], "Delete", "Update"))
